...
export function CTA({
  ...
  description = "Tell us where you are and what you're trying to do, and we'll help point you toward the right certification, program, or resource — free, no obligation.",
  primaryCTA = "Get Guidance",
  primaryHref = "/get-guidance",
}: CTAProps) {
  return (
