...
export function Hero({ title, subtitle, image, imageAlt, primaryCTA = "Get Guidance", primaryHref = "/get-guidance" }: HeroProps) {
  ...
  return (
    <section className="relative overflow-hidden">
      <div className="absolute inset-0">
        ...
        {/* Scrim: floor raised to 55% (not the bare 50% minimum) per batch-wide gate learnings tonight */}
        <div className="absolute inset-0 bg-gradient-to-t from-ink/90 via-ink/70 to-ink/55" />
      </div>
