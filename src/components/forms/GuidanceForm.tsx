  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        <div>
          <label htmlFor="gf-street" className="block text-sm font-medium mb-2">Mailing Address</label>
          <input id="gf-street" name="street_address" type="text" required autoComplete="address-line1" placeholder="1234 W Main St"
            className="w-full px-4 py-3 bg-background border border-border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-primary transition-colors" />
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div>
          <label htmlFor="gf-city" className="block text-sm font-medium mb-2">City</label>
          <input id="gf-city" name="city" type="text" required autoComplete="address-level2" placeholder="Phoenix"
            className="w-full px-4 py-3 bg-background border border-border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-primary transition-colors" />
        </div>
        <div>
          <label htmlFor="gf-state" className="block text-sm font-medium mb-2">State</label>
          <select id="gf-state" name="state" required autoComplete="address-level1" defaultValue=""
            className="w-full px-4 py-3 bg-background border border-border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-primary transition-colors">
      ...
      <div>
        <label htmlFor="gf-zip" className="block text-sm font-medium mb-2">ZIP Code</label>
        <input id="gf-zip" name="zip" type="text" required inputMode="numeric" pattern="[0-9]{5}(-[0-9]{4})?" maxLength={10} autoComplete="postal-code" placeholder="85001"
          className="w-full px-4 py-3 bg-background border border-border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-primary transition-colors" />
      </div>
