...
export const metadata: Metadata = {
  title: "Blog",
  description: "Deeper dives on certification program comparisons, recertification deadlines, and state licensing details.",
};
    ...
    <main>
      ...
      <section className="pt-36 pb-12 md:pt-44 bg-muted/40">
        <div className="max-w-4xl mx-auto px-4 md:px-6 text-center">
          <FadeIn>
            <h1 className="text-4xl md:text-6xl font-heading font-bold">Deeper Dives</h1>
            <p className="mt-4 text-lg text-muted-foreground">
              Specific, neutral answers to the questions our main topic pages don&apos;t fully cover.
            </p>
          </FadeIn>
        </div>
      </section>
