    ...
    <main>
      ...
      <section className="relative overflow-hidden">
        <div className="absolute inset-0">
          ...
          <div className="absolute inset-0 bg-gradient-to-t from-ink/90 via-ink/65 to-ink/55" />
        </div>
        <div className="relative z-10 max-w-4xl mx-auto px-4 md:px-6 pt-36 pb-16 md:pt-48 md:pb-20 text-center">
          <p className="text-sm font-semibold text-accent uppercase tracking-wider mb-3">Certification Guide</p>
      ...
      <FAQ
        ...
        subtitle="Real questions installers ask when sorting out certification."
        faqs={content.faqs}
      />

      <section className="py-16 md:py-20 bg-muted/40">
        <div className="max-w-6xl mx-auto px-4 md:px-6">
          <h2 className="text-2xl font-heading font-bold mb-8 text-center">Related Topics</h2>
