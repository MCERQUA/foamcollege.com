      ...
      <section className="pt-36 pb-24 md:pt-44">
        <div className="max-w-3xl mx-auto px-4 md:px-6">
          ...
          <div className="post-prose">
            ...
            <p>
              When you submit a contact or guidance-request form on {site.businessName}, we
              collect the information you provide — including your name, phone number, email
              address, state, and any notes you include. We also record the referring source and
            ...
            <p>
              ...
              help point you toward the right certification program, licensing resource, or CCA
              contact for your situation. We do not sell your personal information to third
              parties.
            </p>
            <h2>Contact</h2>
